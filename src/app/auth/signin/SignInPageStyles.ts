// src/styles/signInPageStyles.ts

import { BLUE } from '@/constants'; // Import BLUE from your constants file

// Define type for sx props if you want stricter typing, or use any
// import { SxProps, Theme } from '@mui/material/styles';
// type CustomSxProps = SxProps<Theme>;

export const signInPageSx = {
  card: {
    minWidth: '30%',
    minHeight: '50%',
